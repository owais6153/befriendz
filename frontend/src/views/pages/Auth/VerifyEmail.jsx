...
import UnverifiedMiddleware from "../../../middleware/unverifiedMiddleware";
import { Images } from "config/images";
const { crossIcon, verifyEmail } = Images;
const VerifyEmail = (props) => {
  return (
    <AuthLayout className="sun-gradient">
      <Helmet>
        <title>Verify your email - {siteTitle()}</title>
      </Helmet>
      ...
      <VerifyEmailForm navigate="/create-password" />
    </AuthLayout>
  );
};
...
export default connect(mapStateToProps)(UnverifiedMiddleware(VerifyEmail));
